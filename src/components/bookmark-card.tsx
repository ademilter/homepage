...
function BookmarkCard({ bookmark }: { bookmark: ILink; score?: number }) {
  ...
  return (
    <article className="mb-4 flex items-center gap-6 rounded-xl bg-white px-4 py-3 sm:px-6 sm:py-5">
      {image && (
        <img
      ...
      <div className="grow">
        ...
        <div className="text-mute mt-0.5 flex items-center gap-1 text-sm">

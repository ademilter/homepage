...
summary: Bu yazı tasarımcıların daha uygulanabilir arayüzler çıkartmasına yardımcı olmak, gelişen ön yüz teknolojileri hakkında fikir sahibi olmasını sağlamak ve ön-yüz geliştiricisine daha iyi işler teslim etmesi için naçizane tavsiyeler içerir.

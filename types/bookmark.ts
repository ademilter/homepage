export type Bookmark = {
  ...
  // collection: { '$ref': 'collections', '$id': 15611214, '$db': '' },
  // lastUpdate: '2021-03-28T01:37:53.050Z',
  // important: false,
  // user: { '$ref': 'users', '$id': 54603, '$db': '' },
  // creatorRef: { avatar: '', _id: 54603, name: 'ademilter', email: '' },
  // sort: number // 254677638,
  // media: [
  //   {
  //     type: 'image',
  //     link: 'https://rdl.ink/render/https%3A%2F%2Ffigma-to-react.vercel.app%2F',
  //     screenshot: true
  //   }
  // ],
}
